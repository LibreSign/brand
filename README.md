...
Latest stable release: https://github.com/LibreSign/brand/releases/latest

Latest development manual: https://github.com/LibreSign/brand/releases/download/latest/libresign-brand-manual.pdf
